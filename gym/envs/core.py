...
from gym.utils.types import TwoIntTupleList, TwoIntTuple, ThreeIntTuple, List
...
class WorldState(object):
    ...
    def __init__(
            ...
            goal_positions: List[TwoIntTupleList] | None=None,
    ...
    def move_agent(self, new_position, agent_id) -> int:
        ...
        if (new_position[0], new_position[1]) in self.agents_curr_pos:
            return -3 # This check is fine as we have already checked if the new_position is the agents current position
...
class Gym:
    ...
    def step(self, action):
        ...
        Parameters:
        * action: tuple(x,y, orientation), the index of the action to take.

        Returns:
        * A tuple containing:
            - observation: array, the observation of the environment after taking the action.
    ...
    def reset(self):
        ...
        Returns:
        * A tuple containing:
            - observation: array, the observation of the environment after resetting.
            - info: dict, additional information about the reset.
        """
        self.environment.current_position = self.environment.start_position
    ...
    def render(self, mode='human'):
        ...
        Parameters:
        * mode: str, the mode of rendering. Currently supports only 'human'.
        ...
        * None
        ...
        # Render the environment using Pygame or some other library
    ...
    def close(self):
        ...
        * None
        """
        # Close any open Pygame or other library windows
    ...
    def get_observation(self):
        ...
        Returns:
        * A numpy array containing the observation.
        """
        # Construct and return the observation
        return np.array(self.environment.)
    ...
    def is_episode_done(self):
        ...
        * A boolean indicating whether the episode is done.
        """
        # Check some condition to determine if the episode is done
        return False

    @property
    def reward_range(self):
        """
        Get the range of possible rewards.

        Returns:
        * A tuple containing the minimum and maximum possible rewards.
        """
        return (-1.0, 1.0)
